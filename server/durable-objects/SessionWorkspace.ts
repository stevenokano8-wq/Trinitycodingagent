 ...
 *
 * Routes:
 *   POST   /credentials          — save encrypted credentials
 *   GET    /credentials          — retrieve decrypted credentials
 *   GET    /files                — list all files (metadata only)
 *   GET    /file?path=…          — read single file
 *   POST   /file                 — write / create file
 *   DELETE /file?path=…          — delete file
 *   DELETE /workspace            — wipe entire workspace
 *   GET    /info                 — session stats
 */
