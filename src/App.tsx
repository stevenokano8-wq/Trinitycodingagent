...
import ExecutionTimeline, { Attachment } from "./components/ExecutionTimeline.tsx";
...
export default function App() {
  ...
  return (
    <div className="h-screen max-h-screen h-[100dvh] max-h-[100dvh] bg-[#FEF0E4] flex flex-col font-sans select-none overflow-hidden antialiased">
      ...
      {/* Settings modal */}
      {isSettingsOpen && <SettingsModal onClose={() => setIsSettingsOpen(false)} dbStatus={dbStatus} onRefresh={fetchInitialData} />}
